    ...
    <div>
      <div className="main">
          ...
          <div className="byLetter">
            {alphabet.map((letter) => (
              <div className="letter">
                ...
                <div>
                  {props.employee
                    .filter((e) => e.lastName.match(letter))
                    .map((filteredEmployee) => (
                      <div>
                        <h2
                          className={
                            filteredEmployee.status ? "active" : "not-active"
                          }
                        >
                        ...
                        <form>
                          <div>
                            <input
                              ...
                              name="status"
                              onChange={() =>
                                radioChange(true, filteredEmployee.id)
                              }
                          ...
                          <div>
                            <input
                              ...
                              name="status"
                              onChange={() =>
                                radioChange(false, filteredEmployee.id)
                              }
                ...
                {props.employee.filter((e) => e.lastName[0].match(letter))
                  .length === 0 ? (
                  <h2>-----------</h2>
                ) : (
                  <></>
        ...
        <div className="birthdayBlock">
          ...
          <h1 className="birthday">Employees birthday</h1>
          <hr />
          <div className="birthday">
            {props.employee.filter((e) => e.status).length === 0 ? (
            ...
            {months.map((m) => (
              <div>
                {props.employee.filter(
                  (e) => e.status && m === moment(e.dob).format("MMMM")
                ).length > 0 ? (
                  <h2>{m}</h2>
                ) : (
                  <></>
                        ...
                        {m === moment(filteredEmployee.dob).format("MMMM") ? (
                          <li>
                            <h3>
                              ...
                              {filteredEmployee.lastName}{" "}
                              {filteredEmployee.firstName} -{" "}
                              {moment(filteredEmployee.dob).format(
                                "D MMMM YYYY"
                              )}
                            </h3>
                          </li>
